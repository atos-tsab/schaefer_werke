		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Quick planning board",
									"targetURL": "#zatosqplanboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zatosqplanboard-display": {
								"semanticObject": "zatosqplanboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zatos.qplanboard",
									"url": sap.ui.require.toUrl("zatos/qplanboard")
								}
							}
						}
					}
