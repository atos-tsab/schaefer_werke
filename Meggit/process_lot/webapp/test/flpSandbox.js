			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"processlot-display": {
								"semanticObject": "processlot",
								"action": "display",
								"description": "Process Lot application.",
								"title": "Process Lot",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=processlot",
									"url": sap.ui.require.toUrl("processlot")
								}
							}
						}
					}
