			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"furnacerun-display": {
								"semanticObject": "furnacerun",
								"action": "display",
								"description": "Furnace Run application.",
								"title": "Furnace Run",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=furnacerun",
									"url": sap.ui.require.toUrl("furnacerun")
								}
							}
						}
					}
